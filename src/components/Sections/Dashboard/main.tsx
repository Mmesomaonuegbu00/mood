...
//     if (hour < 12) return "🌅 Good morning! Want to share how you're feeling today?";
//     if (hour < 18) return "🌞 Good afternoon! Need someone to talk to?";
...
//         try {
//             const userMessage = { _id: `user-${now}`, email, userInput: reflection, aiResponse: "", timestamp: now };
//             setMessages(prev => [...prev, userMessage]);

//             const aiReply = await generateAIResponse({ userInput: reflection });
//             const aiMessage = { _id: `ai-${now}`, email, userInput: reflection, aiResponse: aiReply, timestamp: now };
...
//             </div>
//             <h1>
//                 <span className="text-pink-300">Welcome,</span> {user?.name || "Guest"}
...
//                         <h2 className="text-xl font-semibold mb-4 px-8 pt-4">How do you feel today?</h2>
//                         <MoodSelector
